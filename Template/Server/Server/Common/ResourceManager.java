...
public class ResourceManager implements IResourceManager
{
	...
	protected ArrayList<Customer> customer_backup = new ArrayList<>();
...
//            else
//            {
		customer.undoReserve(key, location, item.getPrice());
		writeData(xid, customer.getKey(), customer);
...
//		}
	...
	public boolean deleteCustomer(int xid, int customerID) throws RemoteException
	{
		...
		Customer customer = (Customer)readData(xid, Customer.getKey(customerID));
		this.customer_backup.add((Customer)customer.clone());
		if (customer == null)
		{
	...
	public boolean unDeleteCustomer(int xid, int customerID) throws RemoteException{
		Customer toUndo = null;
		for (Customer c: this.customer_backup){
		...
		this.customer_backup.remove(toUndo);
		writeData(xid, toUndo.getKey(), toUndo);
		Trace.info("RM::unDeleteCustomer(" + xid + ", " + customerID + ") created a new customer");
		return true;
	}
